...
def main():
    # File paths
    contract_file = 'D:/acadmics/sem 5/Innovation paper/IJCAI IMPLE/seems/seems/IJCAI_FINAL/embedding_with_labels.csv'
    community_file = 'D:/acadmics/sem 5/Innovation paper/IJCAI IMPLE/seems/seems/IJCAI_FINAL/community_embeddings.csv'
    ...
    # Convert labels to numpy for SVM
    ...
    with torch.no_grad():
        ...
        print("MLP Classifier True labels:", true_labels)
        print(classification_report(true_labels, predictions))

    # Train and evaluate the SVM classifier
    svm = SVC(kernel='linear')  # You can choose other kernels like 'rbf' or 'poly'
    svm.fit(X_train.numpy(), y_train.numpy().ravel())

    svm_predictions = svm.predict(X_test.numpy())
    svm_accuracy = accuracy_score(y_test.numpy(), svm_predictions)

    print("SVM Classifier Accuracy:", svm_accuracy)
    print(classification_report(y_test.numpy(), svm_predictions))
